...
namespace SeniorProject
{
    public partial class GameForm3 : Form
    {
        ...
        Game2 game;                                     //instance of game with 2 AI + 1 Human
        ...
        //constructor
        public GameForm3(string difficulty)
        {
            InitializeComponent();
            diff = difficulty;
            game = new Game2(2, diff);
        ...
        private void GameForm3_Shown(object sender, EventArgs e)
        {
            displayCards();
        }
        ...
        private void GameForm3_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void lastCardThrown()
        {
            ...
            //MessageBox.Show(topfieldcardname);
